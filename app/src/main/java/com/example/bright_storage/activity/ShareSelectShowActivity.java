...
public class ShareSelectShowActivity extends AppCompatActivity
{
            ...
            case REQUEST_CODE:
                if (null != data) {
                    ...
                    if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                        ...
                        Toast.makeText(ShareSelectShowActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
                    }
                }
        }
    }
...
//                System.out.println(path);
                ...
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    imageUri = FileProvider.getUriForFile(ShareSelectShowActivity.this, "com.example.bright_storage.camera.file_provider", outputImage);
                } else {
                ...
                // 动态申请权限
                if (ContextCompat.checkSelfPermission(ShareSelectShowActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions((Activity) ShareSelectShowActivity.this, new String[]{Manifest.permission.CAMERA}, 100);
                } else {
                    // 启动相机程序
                    startCamera();
                }
        ...
        choosePhoto.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                mCameraDialog.dismiss();
                if (ContextCompat.checkSelfPermission(ShareSelectShowActivity.this,
                        Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(ShareSelectShowActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                } else {
                    openAlbum();
                }
            }
        ...
        takeCode.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //TODO 扫码
                mCameraDialog.dismiss();
                Intent intent = new Intent(ShareSelectShowActivity.this, ZxingActivity.class);
    ...
    private void setListener()
    {
        ...
        objectNewPath.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ShareSelectShowActivity.this, PathSelectActivity.class);
        ...
        objectSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!legal)
                {
                    Toast.makeText(ShareSelectShowActivity.this, hint, Toast.LENGTH_SHORT).show();
                }
                else
                {
