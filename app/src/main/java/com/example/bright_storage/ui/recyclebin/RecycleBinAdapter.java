...
public class RecycleBinAdapter extends RecyclerView.Adapter<RecycleBinAdapter.MyViewHolder> {
    private Context context;
    private List<StorageUnit> list;
    private layoutInterface layoutInterface;


    public RecycleBinAdapter(Context context, List<StorageUnit> list) {
